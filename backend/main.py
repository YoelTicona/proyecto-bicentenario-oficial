...
from rutas import preferencias , historial, agenda,eventos, expositores #estamos incluyendo las preferencias de rutas
...
def crear_usuario(datos: Usuario):
    uid = datos.email  # Usamos el email como identificador temporal
